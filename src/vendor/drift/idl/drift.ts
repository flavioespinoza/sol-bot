...
export type Drift = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [213, 89, 217, 18, 160, 55, 53, 141];
      accounts: [
        {
          name: "state";
        },
    ...
    },
    {
      ...
      discriminator: [83, 254, 253, 137, 59, 122, 68, 156];
      accounts: [
        {
          name: "state";
        },
    ...
    },
    {
      ...
      discriminator: [66, 80, 107, 186, 27, 242, 66, 95];
      accounts: [
        {
          name: "user";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [88, 175, 201, 190, 222, 100, 143, 57];
      accounts: [
        {
          name: "state";
        },
    ...
    },
    {
      ...
      discriminator: [62, 87, 68, 115, 29, 150, 150, 165];
      accounts: [
        {
          name: "admin";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [103, 152, 103, 102, 89, 144, 193, 71];
      accounts: [
        {
          name: "admin";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [226, 253, 76, 71, 17, 2, 171, 169];
      accounts: [
        {
          name: "admin";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [89, 131, 239, 200, 178, 141, 106, 194];
      accounts: [
        {
          name: "admin";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "protocolIfSharesTransferConfig";
      discriminator: [188, 1, 213, 98, 23, 148, 30, 1];
    },
    {
      name: "prelaunchOracle";
